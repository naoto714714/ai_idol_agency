...
import { ArrowRight, Play, Heart, MessageCircle, Calendar } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-border/50">
            ...
            <div className="w-full md:w-1/3 space-y-2">
              <div className="flex justify-between text-sm font-medium">
                ...
                <span className="text-primary">30% Complete</span>
              </div>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white border border-border/50 hover:border-primary/30 transition-colors cursor-pointer group">
                ...
                <div>
                  <div className="text-xs text-muted-foreground mb-1">Episode 2</div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white border border-border/50 hover:border-primary/30 transition-colors cursor-pointer group">
                ...
                <div>
                  <div className="text-xs text-muted-foreground mb-1">Episode 1</div>
                  <h4 className="font-bold group-hover:text-primary transition-colors">The Audition</h4>
                </div>
              </div>
            </div>
